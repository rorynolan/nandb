...
<!-- badges: start -->
  ...
  [![Codecov test coverage](https://codecov.io/gh/rorynolan/nandb/graph/badge.svg)](https://app.codecov.io/gh/rorynolan/nandb)
[![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/nandb)](https://cran.r-project.org/package=nandb)
![RStudio CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/nandb)
![RStudio CRAN monthly downloads](https://cranlogs.r-pkg.org/badges/nandb)
