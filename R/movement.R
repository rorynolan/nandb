...
#' \emph{never} was (perhaps via \code{\link[autothresholdr]{auto_thresh}}),
#' setting those to \code{NA}.
#'
...
#'   \code{\link[autothresholdr]{auto_thresh}}, so here you set the method for
#'   that function.
#'
#' @return A logical matrix (or vector or array) with \code{TRUE} for pixels
#'   that have too many consecutive low values and \code{FALSE} for the others
#'   (so \code{TRUE} for the \emph{bad} pixels).
